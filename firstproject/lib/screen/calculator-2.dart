...
class _CalculatorScreenState extends State<CalculatorScreen> {
  ...
  void initState() {
    ...
    super.initState(); // ALWAYS call this first (flutter requirement)
    // set eveything to starting values
    _display = '0';
    _firstOperand = '';
    _operator = '';
  ...
  void _onDecimalPressed() {
    ...
    setState(() {
      if(_shouldResetDisplay) {
        ...
        // only add decimal IF there isnt one already
        _display += '.';
      }
  ...
  void _calculateRadius() {
    // TODO: Implement this function using setState
    setState(() {
      // get the radius from display (convert text to number)
