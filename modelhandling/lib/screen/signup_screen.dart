...
import 'package:modelhandling/controller/auth_controller.dart';
...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void register() async {
    ...
    if(passwordController.text.length < 4){
      showMessage("Password must be atleast 4 characters");
    }

    setState(() {
      isLoading = true;
    });
    final result = await controller.register(usernameController.text, passwordController.text);
